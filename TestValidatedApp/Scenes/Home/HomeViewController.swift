...
class HomeViewController: UIViewController {
    ...
    lazy var vidDownImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = .vidDownLogo
    ...
    lazy var bodyLabel: UILabel = {
        ...
        let title = NSMutableAttributedString(string: "Your Ultimate",
    ...
    lazy var descriptionLabel: UILabel = {
        ...
        label.numberOfLines = 0
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "VidDown lets you download videos instantly with speed and ease. No hassle—just seamless, uninterrupted entertainment at your fingertips!"
        return label
    }()
    ...
    lazy var imageGuidToList: UIImageView = {
        let imageView = UIImageView()
        imageView.image = .arrowDownLogo
        imageView.contentMode = .scaleAspectFit
        imageView.translatesAutoresizingMaskIntoConstraints = false
        return imageView
    }()
    ...
    lazy var buttonToListSaved: UIButton = {
        let button = UIButton(type: .system)
        button.setTitle("Go to see saved videos", for: .normal)
        button.setTitleColor(.white, for: .normal)
        button.backgroundColor = .buttonBg
        button.layer.cornerRadius = 16
        button.translatesAutoresizingMaskIntoConstraints = false
